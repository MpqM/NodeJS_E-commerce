        ...
        <div className='bg-[#ffffff]'>
            {productData ? (
                <div className='fixed w-full h-screen top-0 left-0 bg-[#00000030] z-40 flex items-center justify-center'>
                    <div className='w-[90%] h-[90vh] md:w-[70%] md:h-[75vh]  overflow-y-scroll  bg-[#ffffff] rounded-md shadow relative p-3'>
                        ...
                        <div className='w-full md:flex block'>
                            ...
                            <div className='w-full md:w-[50%] p-5'>
                                ...
                                <div className='flex tems-center justify-between flex-col space-y-1 w-full text-center'>
                                    ...
                                    <div className='text-black flex w-full justify-center bg-white p-3 rounded-md cursor-pointer hover:opacity-50 border-[1px] border-black' onClick={() => setClick(!click)}>
                                        {click
                                    ...
                                    <Link to={`/product/${productData.id}`} className='text-black flex w-full justify-center bg-white p-3 rounded-md cursor-pointer hover:opacity-50 border-[1px] border-black'> <CiSearch size={25} className='mr-3' /> 상품보기</Link>
                                </div>
                            </div>
                        </div>
                    </div>
