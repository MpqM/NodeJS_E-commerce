          ...
          <div className='w-full py-4'>
            <div className='block w-full xl:flex'>
              <div className='w-full xl:w-[50%] '>
                <img src={productData.image_Url[select].url} className='w-full xl:w-[75%] h-[400px] xl:h-[500px] mb-1' />
                <div className='w-full flex'>
                  <div className={`${select === 0 ? "border-[1px] border-black" : "null"} cursor-pointer`}>
                    <img src={productData?.image_Url[0].url} className='h-[100px] xl:h-[200px]' onClick={() => setSelect(0)} />
                  </div>
                  <div className={`${select === 1 ? "border-[1px] border-black" : "null"} cursor-pointer`}>
                    <img src={productData?.image_Url[1].url} className='h-[100px] xl:h-[200px]' onClick={() => setSelect(1)} />
                  </div>
                </div>
              </div>
              <div className='w-full xl:w-[50%]'>
