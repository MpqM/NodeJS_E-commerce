        ...
        <div className='w-full block bg-white rounded-md md:flex p-2 my-10'>
            ...
            <div className='w-full md:[w-50%] flex flex-col justify-center mr-[70px]'>
                ...
                <div className='flex justify-between font-bold text-[20px] mb-3'>
                    <div className='flex'>
                        <h1 className='mr-2'>{promotionData.price === 0 ? promotionData.price : promotionData.discount_price} 원</h1>
                        <h1 className='text-[#ff0000] line-through'>{promotionData.price ? promotionData.price + "원" : null}</h1>
                    </div>
                    <h1 className='text-[20px]'>{promotionData.total_sell} 판매</h1>
                </div>
